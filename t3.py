...
aditmadzs = LineClient(authToken='EyfLNnXW8KawHdIem5wf.elYFTRZfqLa1zXCZwiMgtW.v2ZdzZxDBy4O8gE+6Tmr3GyyiOelge/5gZWFUShLpdQ=')
...
#ki = LineClient()
ki = LineClient(authToken='EyfLNnXW8KawHdIem5wf.elYFTRZfqLa1zXCZwiMgtW.v2ZdzZxDBy4O8gE+6Tmr3GyyiOelge/5gZWFUShLpdQ=')
...
owner = ["u10bc9fb6bcc54250356717335889864f"]
admin = ["u10bc9fb6bcc54250356717335889864f"]
staff = ["u10bc9fb6bcc54250356717335889864f"]
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        aditmadzs.acceptGroupInvitation(op.param1)
                        ginfo = aditmadzs.getGroup(op.param1)
                        ki.sendMessage(op.param1,"Haii, salken yaa ^^")
                    else:
                        aditmadzs.acceptGroupInvitation(op.param1)
                        ginfo = aditmadzs.getGroup(op.param1)
                        ki.sendMessage(op.param1,"Haii, salken yaa ^^")
               ...
               if msg.to in simisimi:
                   try:
                       if msg.text is not None:
                           ...
                           if data["status"] == 200:
                               ki.sendMessage(msg.to, str(data["answer"])) 
                   except Exception as error:
                       pass
           ...
           if wait["selfbot"] == True:
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           ki.sendMessage(msg.to, None, contentMetadata={"STKID":"51626512","STKPKGID":"11538","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           ki.sendMessage(msg.to, "nu ngetag ngode dipman biasana😂😂\nYukk tingali pm😄😄..")
               ...
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ki.sendMessage(msg.to, "Tag cipok yeuh....")
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        ki.sendMessageWithURL(msg.to, image)
                 ...
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["addbots"] = True
                        ki.sendMessage(msg.to,"Berhasil menambahkan ke anggota bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["mid"])
                        ki.sendMessage(msg.to,"Berhasil menghapus dari anggota bot")
                    else:
                        wait["dellbots"] = True
                        ki.sendMessage(msg.to,"Contact itu bukan anggota Aditmadzs BOT")
#===========ADD STAFF============#
                 if msg._from in admin:
                  if wait["addstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        ...
                        wait["addstaff"] = True
                        ki.sendMessage(msg.to,"Berhasil menambahkan ke staff")
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        staff.remove(msg.contentMetadata["mid"])
                        ki.sendMessage(msg.to,"Berhasil menghapus dari staff")
                        wait["dellstaff"] = True
                    else:
                        wait["dellstaff"] = True
                 ...
                 if msg._from in admin:
                  if wait["addadmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["addadmin"] = True
                        ki.sendMessage(msg.to,"Berhasil menambahkan ke admin")
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        admin.remove(msg.contentMetadata["mid"])
                        ki.sendMessage(msg.to,"Berhasil menghapus dari admin")
                    else:
                        wait["delladmin"] = True
                 ...
                 if msg._from in admin:
                  if wait["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = True
                        ki.sendMessage(msg.to,"Berhasil menambahkan ke blacklist user")
                  if wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        ki.sendMessage(msg.to,"Berhasil menghapus dari blacklist user")
                    else:
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                ki.sendMessage(msg.to, "Selfbot diaktifkan")
                                
                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                ki.sendMessage(msg.to, "Selfbot dinonaktifkan")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               ki.sendMessage(msg.to, str(helpMessage2))
                               
                        elif cmd == "translate":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               helpTranslate = translate()
                               ki.sendMessage(msg.to, str(helpTranslate))                               
                               
                        if cmd == "cie on":
                            if msg._from in admin:
                                wait["unsend"] = True
                                ki.sendMessage(msg.to, "Cie 😎")
                        ...
                        if cmd == "cie off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                timeNow = datetime.now(tz=tz)
                                md = "  ┏━━━━━━━━━━━\n┃┃          🐚 S T A T U S 🐚\n┃┣━━━━━━━━━━━━━\n"
                                if wait["unsend"] == True: md+="┃┃🍁 ✔️ Cie「ON」\n"
                                else: md+="┃┃🍁 ✖ Cie「OFF」\n"                                
                                ...
                                if msg.to in protectkick: md+="┃┃🍁 ✔️ Unkick「ON」\n"
                                else: md+="┃┃🍁 ✖ Unkick「OFF」\n"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 Penyihirs SelfBOT 1 Assist 」\n")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               ki.sendMessage(msg.to, "Nama : "+str(mi.displayName)+"\nMID : " +key1)
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                ki.sendMessage(to,"⏩ Group Name : [ " + str(G.name) + " ]\n\n   [ List Member ]\n" + ret_ + "\n\n「Total %i Members」" % len(G.members))
                            except: 
                                pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  ki.sendMessage(to, "Berhasil tolak sebanyak {} undangan grup".format(str(len(ginvited))))
                              else:
                                  ki.sendMessage(to, "Tidak ada undangan yang tertunda")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to,"⏩ Admin Penyihirs BOT\n\n⏩Creator BOT:\n"+ma+"\n⏩Admin:\n"+mb+"\n⏩Staff:\n"+mc+"\n⏩Total「%s」" %(str(len(owner)+len(admin)+len(staff))))
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ...
                                        ki.leaveGroup(i)
                                        ki.sendMessage(to,"Berhasil keluar dari grup " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to, " ❧ BOT Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 ki.sendMessage(msg.to, "Lurking berhasil diaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 ki.sendMessage(msg.to, "Lurking berhasil dinoaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if msg._from in admin:
                            if msg.to in Setmain['ADITMADZSreadPoint']:
                                if Setmain['ADITMADZSreadMember'][msg.to] != {}:
                                    ...
                                    ki.sendMessage(msg.to, "User kosong...")
                            else:
                                ki.sendMessage(msg.to, "Ketik lurking on dulu")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  ki.sendMessage(msg.to, "kamera aktif😎\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  ki.sendMessage(msg.to, "kamera mati\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:    
                            try:
                                ...
                                ki.sendImageWithURL(msg.to, str(data["gambar"]))
                                ki.sendMessage(msg.to, str(hasil))
                                ki.sendMessage(msg.to, "Downloading...")
                                ki.sendMessage(msg.to, "「 Result MP3 」")
                                ki.sendAudioWithURL(msg.to, str(audio["mp3"]))
                                ki.sendMessage(msg.to, "「 Result M4A 」")
                                ki.sendVideoWithURL(msg.to, str(audio["m4a"]))
                                ki.sendMessage(msg.to, str(data["lirik"]))
                                ki.sendMessage(msg.to, "Success Download...")
                            except Exception as error:
                            	ki.sendMessage(msg.to, "「 Result Error 」\n" + str(error))
                            ...
                            if msg._from in admin:
                                ...
                                data = r.json()
                                ki.sendMessage(msg.to,"Hasil : "+str(data["url"]))
                          ...
                          if msg._from in admin:    
                            try:
                                ...
                                t+="\n\n[ Finish ]\n\n"+str(lirik)
                                ki.sendMessage(msg.to, str(t))
                                ki.sendAudioWithURL(msg.to, data["url"])
                            except Exception as error:
                                pass
                                ...
                                if len(cond) == 1:
                                    ...
                                    if num <= len(data["result"]):
                                        ...
                                        if data["result"] != []:
                                            ...
                                            ret_ += "\n┗━━[ Tunggu Audionya ]━━━"
                                            ki.sendMessage(msg.to, str(ret_))
                                            ki.sendAudioWithURL(msg.to, str(data["result"]["mp3"][0]))
                            except Exception as error:
                                pass
                            ...
                            try:
                                ...
                                if len(cond) == 1:
                                    ...
                                    if num <= len(data["results"]):
                                        ...
                                        ki.sendMessage(msg.to, str(lyric))
                            except Exception as error:
                                pass                                        
                          ...
                          if msg._from in admin:
                                ...
                                if data != []:
                                    for food in data:
                                        ki.sendImageWithURL(msg.to, str(food["url"]))
                          ...
                          if msg._from in admin:    
                            try:
                                ...
                                ki.sendMessage(msg.to, "Open Smule...")
                                time.sleep(2)
                                ki.sendMessage(msg.to, "ID Smule : "+smule+"\nLink : "+links)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                ki.sendVideoWithURL(msg.to, me)
                                ki.sendMessage(msg.to,title+ author+ durasi+ suka+ rating+ deskripsi)
                            except Exception as e:
                                ki.sendMessage(msg.to,str(e))
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                for s in stream:
                                    ...
                                    rating = '\n❧ Rating : ' + str(vid.rating)
                                    deskripsi = '\n❧ Deskripsi : ' + str(vid.description)
                                ki.sendImageWithURL(msg.to, me)
                                ki.sendAudioWithURL(msg.to, shi)
                                ki.sendMessage(msg.to,title+ author+ durasi+ suka+ rating+ deskripsi)
                            except Exception as e:
                                ki.sendMessage(msg.to,str(e))
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                details = "\n========INSTAGRAM INFO ========"
                                ki.sendMessage(msg.to, detail + user + user1 + followers + following + post + link + details)
                                ki.sendImageWithURL(msg.to, AR)
                            except Exception as njer:
                                ki.sendMessage(msg.to, str(njer))
                          ...
                          if msg._from in admin:
                            ...
                            ki.sendMessage(msg.to,"🐚 I N F O R M A S I 🐚\n\n"+"🐚 Date Of Birth : "+lahir+"\n🐚 Age : "+usia+"\n🐚 Ultah : "+ultah+"\n🐚 Zodiak : "+zodiak)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to,"Total Spamtag Diubah Menjadi " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                ki.sendMessage(msg.to,"Total Spamcall Diubah Menjadi " +strnum)
                           ...
                           if msg._from in admin:
                                if 'MENTION' in msg.contentMetadata.keys()!=None:
                                    ...
                                    if jmlh <= 1000:
                                        ...
                                        ki.sendMessage(msg.to,"Jumlah melebihi 1000")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                ki.sendMessage(msg.to, "😆😆".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                                    ...
                                    ki.sendMessage(msg.to,"Jumlah melebihi batas")
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      ki.sendMessage(midd, None, contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58', 'PRDTYPE': 'THEME', 'MSGTPL': '5'}, contentType=9)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in creator:
                               ki.sendMessage(msg.to,"Aditmadzs\n"+aditmadzs.authToken)
                               ki.sendMessage(msg.to,"KI\n"+ki.authToken)
...
#===========Protection============#                                    
                        ...
                        elif 'Unkick ' in msg.text: 
                           if msg._from in admin:
                              spl = msg.text.replace('Unkick ','')
                              if spl == 'on': 
                                  if msg.to in protectkick:
                                       ...
                                       ginfo = aditmadzs.getGroup(msg.to)
                                       msgs = "Bala tamtama di kerahkeun\nDi Group : " +str(ginfo.name)
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                wait["addadmin"] = True
                                ki.sendMessage(msg.to,"Kirim kontaknya...")
                            ...
                            if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to,"Berhasil di Refresh...")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to,"Auto respon gift diaktifkan")

                        elif cmd == "respongift off" or text.lower() == 'respongift off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = False
                                ki.sendMessage(msg.to,"Auto respon gift dinonaktifkan")                                
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                ki.sendMessage(msg.to,"Auto Leave Diaktifkan")

                        elif cmd == "autoleave off" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                ki.sendMessage(msg.to,"Auto Leave Dimatikan")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
                                ki.sendMessage(msg.to,"Auto Add Dimatikan")

                        elif cmd == "sticker on" or text.lower() == 'sticker on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                ki.sendMessage(msg.to,"Detect Sticker Diaktifkan")

                        elif cmd == "sticker off" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = False
                                ki.sendMessage(msg.to,"Detect Sticker Dimatikan")

                        elif cmd == "jointicket on" or text.lower() == 'jointicket on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = True
                                ki.sendMessage(msg.to,"Auto Join Ticket Diaktifkan")

                        elif cmd == "jointicket off" or text.lower() == 'jointicket off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = False
                                ki.sendMessage(msg.to,"Auto Join Ticket Dimatikan")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ki.sendMessage(msg.to,"Tidak ada Talkban user")
                              else:
                                ma = ""
                                a = 0
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +aditmadzs.getContact(m_id).displayName + "\n"
                                ki.sendMessage(msg.to,"⏩ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ki.sendMessage(msg.to, "Gagal mengganti Pesan Message")
                              else:
                                  wait["message"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ki.sendMessage(msg.to, "Gagal mengganti Leave Message")
                              else:
                                  wait["leave"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ki.sendMessage(msg.to, "Gagal mengganti Respon Message")
                              else:
                                  wait["Respontag"] = spl
                        ...
                        elif text.lower() == "cek kamera":
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "「kamera Msg」\kamera Message lu :\n\n「 " + str(wait["mention"]) + " 」")
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     ki.sendMessage(msg.to, "AditmadzsOTW MASUK KE GROUP : %s" % str(group.name))
